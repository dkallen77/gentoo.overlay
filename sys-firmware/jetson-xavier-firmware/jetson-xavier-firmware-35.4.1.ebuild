...
DESCRIPTION="NVIDIA Jetson Xavier firmware package"
HOMEPAGE="https://developer.nvidia.com/embedded/linux-tegra"
MY_P="jetson_linux_r${PV}"
SRC_URI="https://developer.nvidia.com/downloads/embedded/l4t/r$(get_major_version)_release_v$(get_after_major_version)/release/${MY_P}_aarch64.tbz2"
